...
const VISIBLE_INTERNAL_KEY_REWRITES = Object.freeze({
  ...
  registry_use_note: "review_framework_note",
  registry_rows_assessed: "review_items_assessed",
  supporting_registry_rows: "supporting_review_items",
  supporting_registry_references: "appendix_cross_references",
  entry_number: "appendix_row_number",
  trigger_if_result: "finding_threshold_outcome",
  exclude_if_result: "control_exclusion_outcome",
  final_status: "assessment_outcome",
  condition_trigger_basis: "condition_basis",
  raw_registry_payload: "appendix_only_detail",
  feature_id: "feature_reference",
  data_flow_id: "data_flow_reference",
  linked_feature_id: "linked_feature_reference",
  linked_threat_ids: "appendix_cross_references",
  finding_id: "finding_reference",
  appendix_refs: "appendix_cross_references",
  hunter_signal_trigger: "applicability_basis",
  active_archetypes: "active_functional_profiles",
  active_surfaces: "active_legal_risk_surfaces"
});
...
const VISIBLE_INTERNAL_TEXT_REPLACEMENTS = Object.freeze([
  ...
  [/\bregistry use note\b/gi, "review framework note"],
  [/\bRegistry Reference\b/g, "Appendix Row Reference"],
  [/\bRegistry Rows?\b/g, "Review Items"],
  [/\bSupporting Registry Items?\b/g, "Supporting Review Items"],
  [/\bRows Assessed\b/g, "Review Items Assessed"],
  ...
  [/\bfinal_status\b/g, "assessment outcome"],
  [/\bcondition_trigger_basis\b/g, "condition basis"],
  [/\braw_registry_payload\b/g, "appendix-only detail"],
  [/\bfeature_id\b/g, "feature reference"],
  [/\bdata_flow_id\b/g, "data flow reference"],
