...
function compactTargetFeatureProfile(profile = {}) { return { target_profile: profile.target_profile || {}, primary_product: profile.primary_product || {}, product_feature_map: Array.isArray(profile.product_feature_map) ? profile.product_feature_map : [], feature_map_scratchpad: Array.isArray(profile.feature_map_scratchpad) ? profile.feature_map_scratchpad : [], limitations: Array.isArray(profile.limitations) ? profile.limitations : [] }; }
