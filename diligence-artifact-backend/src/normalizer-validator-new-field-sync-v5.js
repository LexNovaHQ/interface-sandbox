...
export function validateNormalizedProfilerOutput(output = {}) {
  ...
  if (!section6.includes("qualified_review_legal_signals") || !section6.includes("Qualified Review Legal Signals")) failures.push("Section 6 missing qualified review legal signals subsection");
  ...
  return {
    ...
    failures,
    warnings,
    validator_version: "normalizer_validator_v7_new_field_sync_wrapper"
  };
}
