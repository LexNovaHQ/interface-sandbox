// Compatibility bridge only. Pipeline contracts are owned by the central runtime.
...
export function getPhaseContract(phase) { return getPipelineContract(phase); }
export function getRequiredWritesForPhase(phase) { return getPhaseContract(phase).writes || []; }
