...
const CRITICAL_PATTERNS = Object.freeze([
  ...
  /PACKAGE_LIFECYCLE_(?:INVALID|MISSING|CATALOG_MISMATCH|MOUNTABLE_ASSET_GAP|NOT_EXECUTABLE_POST_REVIEW)/i,
...
const REINVESTIGATION_PATTERNS = Object.freeze([
  ...
  /PRIMARY_DOMAIN_(?:NOT_DERIVED|NOT_IN_CATALOG|MISSING|UNRESOLVED)/i,
  /MULTIPLE_PRIMARY_DOMAIN/i,
