...
const LOCK_STATUSES = Object.freeze(["CREATED", "RUNNING", "LOCKED", "LOCKED_WITH_LIMITATIONS", "REINVESTIGATION_REQUIRED", "CONTROLLED_FAILURE", "COMPLETE", "COMPLETE_WITH_WARNINGS", "COMPLETE_WITH_COUNSEL_ACTIONS"]);
