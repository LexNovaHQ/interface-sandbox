export const CENTRAL_ARTIFACT_GROUPS = Object.freeze({
  ...
  LEGAL_CARTOGRAPHY_INDEX: ["legal_cartography_deterministic_map", "legal_cartography_semantic_profile", "legal_cartography_index", "m7_deterministic_legal_signal_overlay", "m10_selected_legal_support_packet"],
  ...
  DATA_PROVENANCE_PROFILE: ["data_provenance_profile", "extended_dap_india_readiness_profile", "integrated_dap_report"],
  DATA_PROVENANCE_FORENSICS: ["data_provenance_profile_forensics"],
...
export const QR_RUNTIME_ARTIFACT_NAMES = Object.freeze([
  ...QR_SECTION_ARTIFACT_NAMES,
...
export function artifactsForCentralPhase(centralPhaseId) {
  return CENTRAL_ARTIFACT_GROUPS[centralPhaseId] || [];
}

export function isQualifiedReviewRuntimeArtifact(artifactName) {
  return QR_RUNTIME_ARTIFACT_NAMES.includes(artifactName);
}
