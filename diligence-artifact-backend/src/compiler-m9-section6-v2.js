...
export function compileFinalOutputHandoff({ run, artifacts }) {
  ...
  output.final_output_handoff = {
    ...
    final_output_handoff: {
      ...
      normalized_sections,
      legacy_archive,
      compiler_trace: { ...(final.compiler_trace || {}), compiler_version: "normalized_profiler_compiler_replacement_v7_m9_summary_section6", deterministic_only: true, no_new_findings_created: true, no_row_re_evaluation: true, normalized_section_count: NORMALIZED_SECTION_KEYS.length, section_6_m9_summary_not_raw_index: true, section_789_artifact_split: true, section_10_merged_forensic_annexure: true, no_separate_section_11: true, full_forensic_payload_rendered_inline: false }
    }
  };
