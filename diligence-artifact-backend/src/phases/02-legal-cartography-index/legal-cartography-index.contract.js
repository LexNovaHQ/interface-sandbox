  ...
  jobs: Object.freeze({
    LEGAL_CARTOGRAPHY_INDEX: Object.freeze({
      ...
      boundary_rules: Object.freeze({
        ...
        must_not_emit_question_id: true,
        must_not_emit_reviewer_question: true
      })
    }),
    LEGAL_SIGNAL_DERIVATION: Object.freeze({
      ...
      boundary_rules: Object.freeze({
        ...
        field_derivation_registry_is_derivation_authority: true,
        qr_question_id_is_not_derivation_authority: true,
        qr_pollution_allowed: false,
        question_id_forbidden: true,
        reviewer_question_forbidden: true,
        ...
        enforceability_conclusion_generated: false,
        risk_conclusion_generated: false,
        unknown_status_forbidden: true
      })
    })
  }),
  required_save_order: Object.freeze([
    "legal_cartography_deterministic_map",
    "legal_cartography_semantic_profile",
    "legal_cartography_index",
    "legal_signal_derivation_profile"
  ]),
  final_downstream_artifacts: Object.freeze([
    "legal_cartography_index",
    "legal_signal_derivation_profile"
  ]),
  deferred_downstream_integrations: Object.freeze([
    "M7 consumes LGC.NOT and TP.JUR signals in a later pass.",
    "M10 consumes DAP.CONTACT and DAP.CM signals in a later pass.",
    "Qualified Review consumes normalized/compiled field outputs later; it does not drive derivation."
  ])
});
...
export const LEGAL_SIGNAL_DERIVATION_PROFILE_CONTRACT = Object.freeze({
  ...
  required_field_groups: Object.freeze({
    legal_notice_contact_signal_map: Object.freeze([
      { field_id: "LGC.NOT.010", field_key: "legal_notice_email" },
      { field_id: "LGC.NOT.011", field_key: "legal_notice_contact_route" },
      { field_id: "LGC.NOT.012", field_key: "legal_notice_contact_evidence_basis" },
      { field_id: "LGC.NOT.013", field_key: "legal_notice_contact_limitation" }
    ]),
    jurisdiction_dispute_signal_map: Object.freeze([
      { field_id: "TP.JUR.003", field_key: "governing_law_country" },
      { field_id: "TP.JUR.004", field_key: "governing_law_state" },
      { field_id: "TP.JUR.005", field_key: "courts_venue" },
      { field_id: "TP.JUR.007", field_key: "jurisdiction_evidence_basis" },
      { field_id: "TP.JUR.008", field_key: "jurisdiction_uncertainty" }
    ]),
    privacy_grievance_contact_signal_map: Object.freeze([
      { field_id: "DAP.CONTACT.001", field_key: "privacy_contact_email" },
      { field_id: "DAP.CONTACT.002", field_key: "grievance_contact_email" },
      { field_id: "DAP.CONTACT.003", field_key: "officer_contact" },
      { field_id: "DAP.CONTACT.004", field_key: "evidence_basis" },
      { field_id: "DAP.CONTACT.005", field_key: "limitation" }
    ]),
    consent_manager_signal_map: Object.freeze([
      { field_id: "DAP.CM.001", field_key: "applicability_signal" },
      { field_id: "DAP.CM.002", field_key: "public_flow_visible" },
      { field_id: "DAP.CM.003", field_key: "consent_artifact_route" },
      { field_id: "DAP.CM.004", field_key: "withdrawal_revocation_grievance_route" },
      { field_id: "DAP.CM.005", field_key: "third_party_route_signal" },
      { field_id: "DAP.CM.006", field_key: "evidence_basis" },
      { field_id: "DAP.CM.007", field_key: "limitation" }
    ])
  }),
  ...
  forbidden_statuses: Object.freeze([
    "UNKNOWN",
    "N/A",
    "UNCLEAR",
    "NOT_FOUND",
  ...
  required_row_fields: Object.freeze([
    "field_id",
    "field_key",
    "field_family",
    "derivation_status",
  ...
  anti_unknown_protocol: Object.freeze({
    unknown_status_forbidden: true,
    absence_must_use_controlled_status: true,
    locator_found_cannot_be_not_derived_after_exhaustive_scan: true,
    value_may_be_blank_only_when_status_explains_absence: true,
    not_derived_after_exhaustive_scan_requires_scanned_sources: true
  }),
  evidence_gates: Object.freeze({
    DERIVED: "evidence_basis_min_1",
    DERIVED_WITH_LIMITATION: "evidence_basis_min_1_and_limitation_required",
    LOCATOR_FOUND_VALUE_NOT_VISIBLE: "locator_basis_min_1",
    SOURCE_CONFLICT: "evidence_basis_min_2",
    NOT_DERIVED_AFTER_EXHAUSTIVE_SCAN: "scanned_sources_min_1_and_failure_reason_required"
  }),
  forbidden_keys_anywhere: Object.freeze([
    "question_id",
    "reviewer_question",
    "question_rows",
    "question_index",
