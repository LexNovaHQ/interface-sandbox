...
function fail(failures) { return { status: "REPAIR_REQUIRED", failed_gates: failures, repair_instructions: ["Return exactly one legal_cartography_index object using Phase 2 index-only contract. Keep legal signal derivation in legal_signal_derivation_profile and do not emit old M10/4B/4C artifacts."] }; }
