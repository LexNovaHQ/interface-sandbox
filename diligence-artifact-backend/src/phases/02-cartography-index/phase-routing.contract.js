...
export const PHASE_ROUTE_IDS = Object.freeze({ targetProfile: "ROUTE.PHASE3A.TARGET_PROFILE", domainDerivation: "ROUTE.PHASE3B.DOMAIN_DERIVATION", activityProfile: "ROUTE.PHASE5.ACTIVITY_PROFILE", dataPrivacy: "ROUTE.PHASE7.DATA_PROVENANCE_PROFILE", domainControlObligation: "ROUTE.PHASE8.DOMAIN_CONTROL_OBLIGATION_PROFILE", legalCartographySignals: "ROUTE.PHASE10.EXPOSURE_PROFILE" });
...
export const P2G_ROUTE_BUCKETS = Object.freeze([
  ...
  route({
    ...
    job_scoped_derived_profiles: { M12: M12_DERIVED_INPUTS },
    job_scoped_delivery_modes: { M12: P2G_DERIVED_ONLY_DELIVERY_MODE },
    job_scoped_dynamic_inputs: { M12: [P2G_DYNAMIC_M11_BATCH_INPUT] },
    allowed_runtime_context: ["domain_selection_profile", "active_run_package_manifest"],
    requires_legal_dependency: true,
