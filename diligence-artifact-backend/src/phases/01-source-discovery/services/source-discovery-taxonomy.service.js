export const COMMON_ROOTS = Object.freeze([
  { id: "homepage_landing", priority: "PRIMARY", buckets: ["company_identity_sources", "commercial_positioning_sources"], paths: ["/"] },
  { id: "about_company", priority: "PRIMARY", buckets: ["company_identity_sources", "jurisdiction_market_signals"], paths: ["/about", "/about-us", "/company", "/our-company", "/who-we-are"] },
  { id: "legal_identity_notice", priority: "PRIMARY", buckets: ["company_identity_sources", "contact_notice_sources"], paths: ["/legal-notice", "/imprint", "/controller"] },
  ...
  { id: "support_help", priority: "SECONDARY", buckets: ["technical_docs_sources", "product_activity_sources"], paths: ["/help", "/support", "/faq", "/knowledge-base"] },
  { id: "blog_resources", priority: "SECONDARY", buckets: ["third_party_profile_sources"], paths: ["/blog", "/blogs", "/resources", "/guides", "/webinars"] },
  { id: "careers_hiring", priority: "SECONDARY", buckets: ["third_party_profile_sources"], paths: ["/careers", "/jobs", "/hiring"] },
  { id: "public_repository_developer_assets", priority: "SECONDARY", buckets: ["technical_docs_sources", "api_integration_sources"], paths: ["/github", "/open-source", "/developers"] },
  { id: "third_party_profiles", priority: "SECONDARY", buckets: ["third_party_profile_sources", "customer_segment_signals"], paths: [] }
]);
...
export const ADAPTERS = Object.freeze([
  ...
  { adapter_id: "fintech", adapter_type: "primary_domain_package", paths: ["/payments", "/lending", "/credit", "/underwriting", "/banking", "/kyc", "/risk", "/fraud"] },
