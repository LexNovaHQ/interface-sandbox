...
export const NEUTRAL_BUCKETS = Object.freeze(["company_identity_sources", "commercial_positioning_sources", "product_activity_sources", "technical_docs_sources", "api_integration_sources", "pricing_plan_sources", "legal_terms_sources", "privacy_security_sources", "trust_compliance_sources", "regulated_activity_signals", "ai_mechanism_signals", "data_processing_signals", "contact_notice_sources", "thin_or_missing_source_gaps", "customer_segment_signals", "jurisdiction_market_signals", "support_context_sources"]);
export const SOURCE_SIGNAL_ROLES = Object.freeze(["TARGET_IDENTITY_SIGNAL", "CONTACT_NOTICE_SIGNAL", "COMMERCIAL_AVAILABILITY_SIGNAL", "COMMERCIAL_POSITIONING_SIGNAL", "PRODUCT_ACTIVITY_SIGNAL", "TECHNICAL_MECHANICS_SIGNAL", "API_INTEGRATION_SIGNAL", "DATA_FLOW_SIGNAL", "DATA_PROCESSING_SIGNAL", "DATA_GOVERNANCE_SIGNAL", "SECURITY_TRUST_SIGNAL", "AI_MECHANISM_SIGNAL", "AI_SAFETY_TRANSPARENCY_SIGNAL", "REGULATED_ACTIVITY_SIGNAL", "CUSTOMER_SEGMENT_SIGNAL", "LEGAL_DOCUMENT_SIGNAL", "LEGAL_NOTICE_SIGNAL", "VENDOR_PROCESSING_SIGNAL", "SUPPORT_CONTEXT_SIGNAL"]);
...
export function neutralBucketsForSource(source = {}) {
  ...
  if (["credit", "loan", "health", "clinical", "hiring", "recruit", "biometric", "kyc", "children", "minor", "student", "payment", "banking", "underwriting", "medical", "patient"].some((token) => tokens.has(token))) extra.push("regulated_activity_signals");
