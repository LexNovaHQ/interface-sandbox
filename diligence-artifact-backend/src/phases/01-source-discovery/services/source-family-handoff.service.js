...
export function buildSourceFamilyHandoffArtifact({ run, artifacts }) {
  ...
  return {
    source_discovery_handoff: {
      ...
      schema_version: "PHASE1_SOURCE_DISCOVERY_HANDOFF_v3_FULL_ROOT_MATRIX_MULTI_DOMAIN",
      status: hasPrimary(commonRootIndex) || legalDocs.length ? "LOCKED" : "LOCKED_WITH_LIMITATIONS",
      contract: {
        formal_output: "source_discovery_handoff",
        purpose: "Index Phase 1 locked common-root source files, full 17-root matrix metadata, neutral evidence buckets, and independent legal document artifacts for downstream profile consumers.",
        source_discovery_prevails: true,
        no_new_urls: true,
        no_new_extraction: true,
        no_full_text: true,
        full_17_root_classifier_matrix_preserved: true,
        ...
        multi_domain_union_probe_preserved: true,
    ...
    post_phase_1_domain_gate_handoff: {
      ...
      target_url: targetUrl,
      generated_by: "source_discovery_handoff",
      schema_version: "POST_PHASE_1_DOMAIN_GATE_HANDOFF_v3_FULL_ROOT_MATRIX_MULTI_DOMAIN",
