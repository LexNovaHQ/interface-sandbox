...
const DEFAULT_MIN_CHARACTERS = positiveInt(process.env.LN_PHASE1_MIN_MATERIAL_CHARACTERS, 120);
const DEFAULT_MIN_TOKENS = positiveInt(process.env.LN_PHASE1_MIN_MATERIAL_TOKENS, 20);
const DEFAULT_MIN_UNIQUE_TOKENS = positiveInt(process.env.LN_PHASE1_MIN_MATERIAL_UNIQUE_TOKENS, 8);
