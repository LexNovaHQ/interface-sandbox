import { DATA_PROVENANCE_SOURCE_ARTIFACT_NAMES, SOURCE_DISCOVERY_LEGAL_DOC_CONTROL_ARTIFACT_NAMES } from "../../runtime/contracts/artifact-permissions.contract.js";
...
export const PHASE7_DATA_PRIVACY_ARCHITECTURE_CONTRACT = Object.freeze({
  contract_name: "PHASE7_DATA_PRIVACY_ARCHITECTURE_PACKAGE_CONTRACT_v4_AGNOSTIC_SOURCE_ROOTS",
  ...
  implementation_status: "LAYER_5_BATCH_QUALITY_SCHEMA_VALIDATOR_BUILT_RUNTIME_CUTOVER_AGNOSTIC_SOURCE_INPUTS",
  ...
  approved_input_universe: Object.freeze(["source_discovery_handoff", "domain_selection_profile", "active_run_package_manifest", "legal_cartography_index", "legal_signal_derivation_profile", "target_profile", "target_profile_forensics", "feature_candidate_inventory", "target_feature_profile", "target_feature_profile_forensics", ...DATA_PROVENANCE_SOURCE_ARTIFACT_NAMES, ...SOURCE_DISCOVERY_LEGAL_DOC_CONTROL_ARTIFACT_NAMES, "legal_doc_{DOC_TYPE}"]),
  navigation_rules: Object.freeze({
    data_privacy_navigation_index_is_hybrid: true,
    deterministic_system_builds_index_spine: true,
    semantic_system_adds_common_root_and_legal_doc_navigation_pointers: true,
    full_data_source_evidence_allowed_only_through_data_privacy_navigation_index: true,
    selective_legal_doc_evidence_allowed_only_through_legal_cartography_index: true,
    selective_legal_signal_support_allowed_only_through_legal_signal_derivation_profile: true,
  ...
  layer_contracts: Object.freeze([
    ...
    layer(4, "Semantic Source Batch Runner", "semantic_batch", ["dap_semantic_batch_route_manifest", "data_privacy_navigation_index"], PHASE7_DAP_SEMANTIC_BATCH_PLAN.map((batchRow) => batchRow.artifact_name)),
