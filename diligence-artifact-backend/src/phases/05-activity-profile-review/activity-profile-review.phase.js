export const ACTIVITY_PROFILE_REVIEW_PHASE = Object.freeze({
  ...
  implementation_status: "ACTIVITY_PROFILE_REVIEW_MATERIAL_RUNNER_SMOKED",
  ...
  runner_status: "ACTIVITY_CANDIDATE_INVENTORY_PHASE_RUNNER_CUTOVER_STAGED_ACTIVITY_PROFILE_REVIEW_MATERIAL_RUNNER_SMOKED",
  runtime_boundary: "Runtime orchestrates persistence and locking. Activity Candidate Inventory is staged for phase-owned runner cutover. Activity Profile Review material contract and runner smoke are locked; material runtime cutover remains pending.",
