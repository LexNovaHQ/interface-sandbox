export const ACTIVITY_PROFILE_REVIEW_PHASE = Object.freeze({
  ...
  implementation_status: "ACTIVITY_CANDIDATE_INVENTORY_RUNNER_SMOKED",
  ...
  runner_status: "ACTIVITY_CANDIDATE_INVENTORY_PHASE_RUNNER_ADDED_RUNTIME_SMOKE_ADDED",
  runtime_boundary: "Runtime orchestrates persistence and locking. Phase 5 now has a locked deterministic Activity Candidate Inventory contract and phase-owned runner smoke; Activity Profile Review material migration remains pending.",
