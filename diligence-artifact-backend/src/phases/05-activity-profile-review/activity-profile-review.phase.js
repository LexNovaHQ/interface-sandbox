export const ACTIVITY_PROFILE_REVIEW_PHASE = Object.freeze({
  ...
  implementation_status: "ACTIVITY_PROFILE_REVIEW_MATERIAL_RUNNER_CUTOVER_STAGED",
  ...
  runner_status: "ACTIVITY_CANDIDATE_INVENTORY_PHASE_RUNNER_CUTOVER_STAGED_ACTIVITY_PROFILE_REVIEW_MATERIAL_RUNNER_CUTOVER_STAGED",
  runtime_boundary: "Runtime orchestrates persistence and locking. Activity Candidate Inventory is staged for phase-owned runner cutover. Activity Profile Review material is staged for phase-owned runtime cutover. Activity Profile Forensics remains pending.",
