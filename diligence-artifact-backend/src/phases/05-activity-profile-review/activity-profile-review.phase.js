export const ACTIVITY_PROFILE_REVIEW_PHASE = Object.freeze({
  ...
  implementation_status: "ACTIVITY_CANDIDATE_INVENTORY_CONTRACT_LOCKED",
  ...
  runtime_boundary: "Runtime orchestrates persistence and locking. Phase 5 now has a locked deterministic Activity Candidate Inventory contract; Activity Profile Review material migration remains pending.",
