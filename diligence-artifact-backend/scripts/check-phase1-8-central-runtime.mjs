...
import { ARTIFACT_NAMES, DOMAIN_DERIVATION_ARTIFACT_NAMES, INTERNAL_JOB_WRITE_PERMISSIONS, artifactMatchesPermission } from "../src/runtime/contracts/artifact-permissions.contract.js";
...
const no=["legal_cartography_index","legal_signal_derivation_profile","legal_doc_inventory","legal_doc_extraction_index","legal_doc_{DOC_TYPE}","data_privacy_navigation_index","lossless_root__privacy_data_processing","lossless_root__security_trust_compliance","lossless_root__data_governance_controls"];
...
console.log(JSON.stringify({check:"phase1-8 central runtime",status:"PASS",enforced_gates:["PHASE1_8_JOB_CHAIN","PHASE2A_TARGET_PROFILE_SOURCE_INDEX_RUNTIME_WIRED","PHASE3A_SCOPED_LOSSLESS_TARGET_EVIDENCE","PHASE3B_SCOPED_NON_LEGAL_TARGET_ACTIVITY_EVIDENCE","PHASE3B_AGENT3_ACTIVE_REGISTRY_LADDER_PROMPT"]},null,2));
