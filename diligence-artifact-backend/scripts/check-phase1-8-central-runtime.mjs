...
const tRoots=["lossless_root__homepage_landing","lossless_root__about_company","lossless_root__legal_identity_notice","lossless_root__pricing_commercial_availability","lossless_root__contact_notice","lossless_root__operator_entity_signals","lossless_root__supporting_company_signals"];
const dRoots=["lossless_root__homepage_landing","lossless_root__about_company","lossless_root__product_service","lossless_root__platform_feature_solution","lossless_root__technical_docs_api_developer","lossless_root__docs_api_data_flow","lossless_root__pricing_commercial_availability","lossless_root__use_case_customer_industry","lossless_root__integrations_ecosystem"];
const no=["legal_cartography_index","legal_signal_derivation_profile","legal_doc_inventory","legal_doc_extraction_index","legal_doc_{DOC_TYPE}","data_privacy_navigation_index","lossless_root__privacy_data_processing","lossless_root__security_trust","lossless_root__trust_compliance"];
