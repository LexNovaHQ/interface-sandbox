...
const challenge = readFileSync("src/phases/11-operator-challenge/m12-deterministic-challenge.js", "utf8");

assert.ok(runner.includes('phase_owned_path: "src/phases/11-operator-challenge"'));
...
assert.ok(pipeline.includes('../../phases/11-operator-challenge/operator-challenge.runner.js'), "central pipeline must import Phase 10 directly");
