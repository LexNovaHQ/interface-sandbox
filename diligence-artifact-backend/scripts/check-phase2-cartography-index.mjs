...
assert.equal(CARTOGRAPHY_INDEX_CONTRACT.implementation_status, "INPUT_CONTRACT_SYNCED_TO_PHASE1_V5_17_ROOT_MULTI_DOMAIN_UNION_PROBE_P2B_DOMAIN_SOURCE_INDEX");
...
assert.equal(CARTOGRAPHY_INDEX_CONTRACT.phase2_profile_input_routes.domain_derivation_source_index.activity_profile_source_index_reserved_for_2c_phase5, true);
...
assert.equal(PIPELINE_CONTRACTS.P2B_DOMAIN_DERIVATION_SOURCE_INDEX.next, "P2_INDEX_COMPILER_VALIDATION");
...
const expectedJobs = ["P2_SOURCE_INVENTORY_CARTOGRAPHY", "P2_LOCATOR_SPINE", "P2_PROFILE_ROUTE_MATRIX", "P2_SEMANTIC_NAVIGATION_OVERLAY", "M9", "P2A_TARGET_PROFILE_SOURCE_INDEX", "P2B_DOMAIN_DERIVATION_SOURCE_INDEX", "P2_INDEX_COMPILER_VALIDATION"];
...
console.log("Phase 2 cartography + P2A/P2B runtime wiring validator: PASS");
