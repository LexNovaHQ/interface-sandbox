...
for (const marker of ["assertUnaffectedRowsPreserved", "PHASE11_PHASE10_UNAFFECTED_ROW_MUTATED", "unaffected_batch_count_reused", "full_phase_batch_rerun_performed: false"]) assert.ok(targeted.includes(marker), `targeted Phase 10 missing ${marker}`);
