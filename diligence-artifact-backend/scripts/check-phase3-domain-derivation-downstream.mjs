...
const routedJobs = [...directDomainContextJobs, "DATA_PROVENANCE_PROFILE_FORENSICS"];
...
for (const jobId of directDomainContextJobs) {
...
console.log(JSON.stringify({ check: "phase3 domain derivation downstream", status: "PASS", enforced_gates: ["P2G_DOMAIN_CONTEXT_ROUTING", "NO_SHADOW_CENTRAL_READ_ARRAYS", "PHASE8_LOCKED_PHASE7_ONLY", "REGULATORY_OVERLAY_MANIFEST_SYNC", "FORENSICS_NOT_DOWNSTREAM_PREREQUISITES", "RUNTIME_FLAGS_STAY_FALSE"] }, null, 2));
