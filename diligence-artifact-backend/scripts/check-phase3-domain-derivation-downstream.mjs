...
const update = buildPhase3BDomainDerivationManifestUpdate({
  ...
  domain_derivation_profile: {
    primary_domain_derivation: { selected_package: "fintech", status: "LOCKED", selected_rule_id: "PRIMARY_DOMAIN_FINTECH", package_lifecycle_state: "ACTIVE_REPORT_ONLY", downstream_delivery_mode: "REPORT_ONLY", evaluated_rules: [] },
  ...
  validation: { status: "LOCKED", critical_failures: [], reinvestigation_items: [], limitations: [], warnings: [] }
});
...
assert.equal(update.active_run_package_manifest.activation_flags.phase3b_package_selection_enabled, true);
...
console.log(JSON.stringify({ check: "phase3 domain derivation downstream", status: "PASS", enforced_gates: ["P2G_DOMAIN_CONTEXT_ROUTING_THROUGH_PHASE11", "PHASE12_DIRECT_MATERIAL_PROFILE_INPUTS", "PHASE12_P2G_DEPENDENCY_FORBIDDEN", "NO_SHADOW_CENTRAL_READ_ARRAYS", "PHASE8_LOCKED_PHASE7_ONLY", "REGULATORY_OVERLAY_MANIFEST_SYNC", "FORENSICS_NOT_DOWNSTREAM_PREREQUISITES", "PRE_PHASE1_PASSIVE_PHASE3B_ACTIVE_FLAGS"] }, null, 2));
