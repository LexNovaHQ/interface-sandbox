...
const oldArtifacts = ["extended_dap_india_" + "readiness_profile", "integrated_" + "dap_report"];
...
assert.equal(READ_PERMISSIONS.compiler.includes(oldArtifacts[0]), false);
assert.equal(READ_PERMISSIONS.compiler.includes(oldArtifacts[1]), false);
