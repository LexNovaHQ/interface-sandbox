...
const artifacts = {
  legal_cartography_index: {
    ...
    governing_law_venue_locator: [
      {
        status: "FOUND_INDEXED",
        locator_text: "These Terms are governed by the laws of the State of California. The courts in San Francisco, California have exclusive jurisdiction.",
...
assert.equal(overlay.material_field_overlay["jurisdiction_notice.courts_venue"], "San Francisco, California have exclusive jurisdiction");
...
assert.equal(output.target_profile.jurisdiction_notice.courts_venue, "San Francisco, California have exclusive jurisdiction");
