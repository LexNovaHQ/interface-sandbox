...
const artifacts = {
  ...
  lossless_family__L1_CORE_TERMS_PRIVACY: {
    documents: [
      {
        source_url: "https://example.com/terms",
        clean_text: "These Terms are governed by the laws of the State of California. You consent to the exclusive jurisdiction of the courts located in San Francisco, California."
      }
    ]
  }
};
