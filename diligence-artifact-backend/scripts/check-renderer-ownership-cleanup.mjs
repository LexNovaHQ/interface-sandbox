...
assert.equal(pipeline.includes('../../report-renderer.js'), false, "central pipeline must not use root renderer compatibility bridge");
...
console.log(JSON.stringify({ check: "renderer ownership cleanup", status: "PASS", enforced_gates: ["RENDERER_IMPLEMENTATION_RUNTIME_OWNED", "CENTRAL_PIPELINE_IMPORTS_RENDERER_DIRECTLY", "ROOT_RENDERER_COMPATIBILITY_ONLY", "LOCKED_RENDERER_CONTRACT_PRESERVED"] }, null, 2));
