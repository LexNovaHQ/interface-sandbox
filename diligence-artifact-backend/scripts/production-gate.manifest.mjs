...
export const PRODUCTION_GATE_CHECKS = Object.freeze([
  ...
  gate("cloud-run-capacity", "Cloud Run worker memory and request isolation", "check:cloud-run-capacity", "STRUCTURAL_RUNTIME_SAFETY", CRITICAL_ONLY),
  ...
  gate("semantic-outcome-integrity", "Semantic outcome vocabulary and critical-only blocking", "check:semantic-outcome-integrity", "STRUCTURAL_RUNTIME_SAFETY", CRITICAL_ONLY),
