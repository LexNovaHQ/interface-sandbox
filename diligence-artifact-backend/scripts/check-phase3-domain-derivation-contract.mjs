...
console.log(JSON.stringify({ check: "phase3 domain derivation contract", status: "PASS", enforced_gates: ["AGENT3_BOUND", "ACTIVE_REGISTRY_LADDER_PROMPT", "NEW_DOMAINS_BY_REGISTRY_NOT_PROMPT", "SCOPED_NON_LEGAL_LOSSLESS_READS", "LEGAL_INPUTS_FORBIDDEN", "REGISTRY_SEMANTIC_DERIVATION"] }, null, 2));
