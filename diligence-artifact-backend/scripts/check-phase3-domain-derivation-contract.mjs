...
for (const requiredText of ["DOMAIN_DERIVATION_REGISTRY_v0.yaml", "package-catalog.v0.json", "condition-level", "evidence anchors", "active validator", "new supported domain", "Phase 3B must not emit Lane"]) assert.ok(prompt.includes(requiredText), `3B prompt missing structural marker: ${requiredText}`);
