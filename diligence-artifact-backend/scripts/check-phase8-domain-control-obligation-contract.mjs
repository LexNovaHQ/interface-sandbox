...
assert.equal(DOMAIN_CONTROL_OBLIGATION_PROFILE_CONTRACT.candidate_boundary.candidate_inventory_required, true);
assert.equal(DOMAIN_CONTROL_OBLIGATION_PROFILE_CONTRACT.candidate_boundary.model_may_not_create_new_candidates, true);
assert.equal(DOMAIN_CONTROL_OBLIGATION_PROFILE_CONTRACT.candidate_boundary.model_may_not_drop_candidates, true);
