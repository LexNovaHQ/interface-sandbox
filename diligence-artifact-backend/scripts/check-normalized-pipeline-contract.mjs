...
assert.equal(PHASE_CONTRACTS.NORMALIZED_COMPILER.reads.includes(OLD_4B), false);
assert.equal(PHASE_CONTRACTS.NORMALIZED_COMPILER.reads.includes(OLD_4C), false);
...
assert.equal(READ_PERMISSIONS[QUALIFIED_REVIEW_SYSTEM_AGENT].includes(OLD_4B), false);
assert.equal(READ_PERMISSIONS[QUALIFIED_REVIEW_SYSTEM_AGENT].includes(OLD_4C), false);
