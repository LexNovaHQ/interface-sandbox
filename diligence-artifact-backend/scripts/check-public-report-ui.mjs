...
assert.ok(qualifiedReviewCss.includes("grid-template-columns: 260px"));
assert.ok(qualifiedReviewCss.includes("position: sticky"));
...
assert.ok(qualifiedReviewJs.includes("qr-question-layout"));
assert.ok(qualifiedReviewJs.includes("Why this matters"));
assert.ok(qualifiedReviewJs.includes("Source / basis"));
assert.ok(qualifiedReviewJs.includes("Proceed to Drafting"));
assert.ok(qualifiedReviewJs.includes("assembly-engine.html?run_id="));
assert.ok(qualifiedReviewJs.includes('els.title.textContent = "Qualified Review"'));
