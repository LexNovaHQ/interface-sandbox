...
assert.ok(reportHtml.includes("report-table-overrides.css?v=section-card-rows-20260703"));
assert.ok(reportHtml.includes("report.js?v=section-card-rows-20260703"));
assert.ok(reportHtml.includes("report-ui-sync.js?v=report-rowflow-20260703"));
...
assert.ok(reportUiSyncJs.includes("function activeSection"));
assert.ok(reportUiSyncJs.includes("window.addEventListener(\"scroll\""));
assert.ok(reportUiSyncJs.includes("requestAnimationFrame(run)"));
assert.ok(reportUiSyncJs.includes("classifyCards"));
assert.ok(reportUiSyncJs.includes("single-panel"));
assert.ok(reportUiSyncJs.includes("two-panels"));
assert.ok(reportUiSyncJs.includes("row-flow"));
assert.ok(reportUiSyncJs.includes("MutationObserver"));
assert.ok(reportUiSyncJs.includes("syncRail"));
assert.ok(reportUiSyncJs.includes("syncDeckFooters"));
assert.ok(reportUiSyncJs.includes("report-deck-footer"));
assert.ok(reportUiSyncJs.includes("report-deck-actions-bottom"));
assert.equal(reportUiSyncJs.includes("No visible value emitted"), false);
...
assert.ok(reportJs.includes("Document identity"));
assert.ok(reportJs.includes("Locator"));
assert.ok(reportJs.includes("Control / missing item"));
...
assert.ok(reportJs.includes('layout: "row-groups"'));
assert.ok(reportJs.includes("renderRowGroupReportCard"));
assert.ok(reportJs.includes("renderReportRowGroup"));
assert.ok(reportJs.includes("report-card-row-groups"));
assert.ok(reportJs.includes("report-deck-footer"));
assert.ok(reportJs.includes("renderDeckActions"));
assert.ok(reportJs.includes("Legal_Business_Consequence"));
assert.ok(reportJs.includes("Recommended_Review_Action"));
...
assert.equal(reportJs.includes("Download JSON"), false);
...
assert.ok(reportTableCss.includes(".report-card-row-groups"));
assert.ok(reportTableCss.includes(".report-row-card-body"));
assert.ok(reportTableCss.includes(".report-row-group-grid.compact-4"));
assert.ok(reportTableCss.includes(".report-row-group-grid.wide-2"));
assert.ok(reportTableCss.includes(".report-deck-footer"));
...
assert.ok(reportTableCss.includes("report-deck-footer"));
assert.ok(reportTableCss.includes(".report-deck-footer .report-deck-actions"));
...
assert.ok(reportTableCss.includes(".report-finding-layout.row-flow"));
assert.ok(reportTableCss.includes("grid-template-columns: minmax(88px"));
