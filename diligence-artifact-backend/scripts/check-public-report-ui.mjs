...
assert.ok(qualifiedReviewCss.includes("qr-card-actions .btn.active"));
assert.ok(qualifiedReviewCss.includes("qr-question-card[data-qr-state"));
...
assert.ok(qualifiedReviewJs.includes("Suggestion — prefilled from the diligence review. Confirm or revise."));
...
assert.ok(qualifiedReviewWorkflowJs.includes("updateActionState"));
assert.ok(qualifiedReviewWorkflowJs.includes('not_applicable_reason: state === "not_applicable" ? reason : ""'));
