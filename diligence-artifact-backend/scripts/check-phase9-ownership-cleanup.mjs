...
const rootWrappers = ["m11-orchestrator.js", "m11-orchestrator-m11v2.js", "m11-deterministic-system-m11v2.js", "m11-deterministic-system.js", "m11-status-finalizer.js", "m11-deterministic-forensics-m11v2.js", "m11-deterministic-forensics.js", "m11-forensic-trace-index.js", "m11-lep-deterministic.js", "m11-batch-evidence-resolver.js"];
...
assert.equal(pipeline.includes('../../m11-orchestrator.js'), false, "central pipeline must not use root M11 compatibility bridge");

console.log(JSON.stringify({ check: "Phase 9 ownership cleanup", status: "PASS", enforced_gates: ["M11_IMPLEMENTATION_PHASE_OWNED", "CENTRAL_PIPELINE_IMPORTS_PHASE9_DIRECTLY", "ROOT_M11_FILES_COMPATIBILITY_ONLY", "NO_RETIRED_LOSSLESS_FAMILY_INPUTS", "LOSSLESS_EVIDENCE_PRIMARY_NOT_FALLBACK", "P2G_2F_ROUTING_AUTHORITY_PRESERVED"] }, null, 2));
