...
for (const [before, after] of [
  ...
  ['for (const file of [contract, urlService, extractionService, handoffService, validator, permissions, phaseContracts]) {', 'for (const file of [contract, urlService, extractionService, handoffService, validator, permissions, pipelineContract]) {'],
